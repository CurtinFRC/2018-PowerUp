...
{
	int x_max = 0, x_min = 1234567890, y_max = 0, y_min = 1234567890;
...
int main()
{
	...
	while (true)
	{
		...
		//present graphically
		putText(filtered_contours_mat, "Frames per second: " + std::to_string(fps), {5, 30}, cv::FONT_HERSHEY_SCRIPT_COMPLEX, 0.7, {0xFF, fps*fps + 100, 0xFF});
